...
# and projects so we choose the ones we want to prioritise since its hard to
# get them all.
#
# neutron:
# for path in common/ovn plugins/ml2/common services/ovn_l3 agent/ovsdb/native agent/linux/openvswitch_firewall; do cat neutron/$path/exceptions.py; sed -rn 's/^class\s+(\S+)\(.+/    "\1",/p' neutron/$path/exceptions.py; done
#
# neutron-lib:
